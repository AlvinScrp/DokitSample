...
class DoKitCommTransformV34(project: Project) : DoKitBaseTransform(project) {
    ...
    override fun applyToVariant(variant: VariantInfo): Boolean {
        "variant.buildTypeEnabled:${variant.buildTypeEnabled}".println()
        "variant.flavorNames.isNotEmpty():${variant.flavorNames.isNotEmpty()}".println()
        "variant.fullVariantEnabled:${variant.fullVariantEnabled}".println()
