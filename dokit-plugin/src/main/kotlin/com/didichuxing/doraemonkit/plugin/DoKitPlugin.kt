...
//                        }
                        ...
                        project.gradle.projectsEvaluated {
                            ...
                            androidExt.applicationVariants.forEach { variant ->
                                "===DoKitPluginConfigProcessor process ${project.name}  ${variant.name} ===".println()
                                DoKitPluginConfigProcessor(project).process(variant)
                            }

//                            DoKitExtUtil.setAppPackageName("com.webuy.ark")
//                            DoKitExtUtil.setApplications(mutableSetOf("com.webuy.ark.app.ArkApp"))
//                            val doKitExt = project.extensions.getByType(DoKitExt::class.java)
//                            "===doKitExt:${doKitExt}===".println()
